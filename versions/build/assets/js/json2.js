...
function getToJson(url, callback) {
    ...
    xhr.onreadystatechange = function() {
        ...
        if (xhr.readyState == 4) {
            if (xhr.status == 200) {
                // var ob = ($.csv.toArrays(xhr.responseText));
                // console.log(ob);
                // var rs = ;
                var ob = {};

                // ob = ($.csv.toArrays(rs));
                var j = (csvToJson(xhr.responseText));
                var js = $.parseJSON(j);
...
// USO
// getToJson("https://docs.google.com/spreadsheet/pub?key=0Aloih2-zMHPsdHd3Nk9ta3BiSHpaX25HMDNVeHNmU3c&output=csv", function(rs) {
//     alert(rs);
// });